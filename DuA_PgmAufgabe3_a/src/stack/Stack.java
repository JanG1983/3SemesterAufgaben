...
public class Stack {
	...
	public String version() { // gibt eine Versionsnummer zur�ck
		...
		// return
		// "Version 1.b - Stack; Implementierung als verkettete Liste mit Exception-Handling";
	}
	...
	public void push(Object element) throws StackFullException { // legt ein
																	// Element
																	// auf den
																	// Stack
	...
	public Object pop() throws StackEmptyException { // nimmt ein Element vom
														// Stack
	...
	public Object peek() throws StackEmptyException { // liest oberstes Element
														// vom Stack,
